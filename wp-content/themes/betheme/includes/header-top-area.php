...
<?php 
	if( mfn_header_style( true ) == 'header-overlay' ){
		...
		// Overlay ----------
		echo '<div id="Overlay"><div><img class="logo-main scale-with-grid'. $class .'" src="'. $logo_src .'" alt="'. mfn_get_attachment_data( $logo_src, 'alt' ) .'" '. $width .'/><div class="social_header"><ul class="social"><li class="facebook"><a target="_blank" href="https://www.facebook.com/Junglehouse-Design-191032968011994/" title="Facebook"><i class="icon-facebook"></i></a></li><li class="twitter"><a target="_blank" href="https://twitter.com/Junglehouse_Des" title="Twitter"><i class="icon-twitter"></i></a></li><li class="linkedin"><a target="_blank" href="https://www.linkedin.com/organization/13287900/admin/updates" title="LinkedIn"><i class="icon-linkedin"></i></a></li><li class="pinterest"><a target="_blank" href="https://www.pinterest.com/junglehousedesi/" title="Pinterest"><i class="icon-pinterest"></i></a></li><li class="dribbble"><a target="_blank" href="https://dribbble.com/Junglehouse_Design" title="Dribbble"><i class="icon-dribbble"></i></a></li><li class="instagram"><a target="_blank" href="https://www.instagram.com/junglehouse_design/" title="Instagram"><i class="icon-instagram"></i></a></li><li class="behance"><a target="_blank" href="https://www.behance.net/junglehousedesign" title="Behance"><i class="icon-behance"></i></a></li></ul></div><div class="logo logo_header"><a id="logo" href="http://junglehouse.design/" title="Junglehouse"><img class="logo-main scale-with-grid" src="http://junglehouse.design/wp-content/uploads/2016/09/Vector-Smart-Object-01.png" alt="vector-smart-object-01"></a></div></div>';
			mfn_wp_overlay_menu();
		echo '<div></div></div>';
